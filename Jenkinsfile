    ...
    stages {
        ...
        stage('8 - Deploy to Kubernetes') {
            steps {
                ...
                sh """
                    kubectl apply -f /home/vagrant/mysql-secret.yaml
                    kubectl apply -f /home/vagrant/mysql-pvc.yaml
                    kubectl apply -f /home/vagrant/mysql-deployment.yaml
                    kubectl apply -f /home/vagrant/restaurant-app-deployment.yaml
